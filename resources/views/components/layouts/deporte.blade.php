...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Campings deportivos. Los mejores campings para practicar fútbol, basket, tenis, pádel, minigolf y muchos más.">
        <meta keywords="Campings para hacer deporte, fútbol, basket, ping pong y hasta minigolf.Torneos, ligas y cursos">
        
        <title>PlayCamp - Campings para hacer deporte</title>
