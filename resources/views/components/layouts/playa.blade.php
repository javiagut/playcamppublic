...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Los mejores campings de playa, visita las mejores calas del país, miradores en la costa, acantilados y cerca de actividades marítimas como snorkel o nadar con tiburones">
        <meta keywords="campings de playa, campings de montaña, campings con acantilados, campings paradisíacos, campings en la playa">
        
        <title>PlayCamp - Campings en playas y calas paradisíacas en España</title>
