...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Los mejores campings de montaña, en zonas rurales con paisajes únicos rodeados de bosques, ríos y hasta parques nacionales.">
        <meta keywords="campings de montaña, campings rurales, campings en la naturaleza, campings en parques nacionales, campings con río">
        
        <title>PlayCamp - Campings de montaña, envuélvete de naturaleza</title>
