...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Campings para tener las mejores vacaciones en familia, con actividades únicas para los más pequños.">
        <meta keywords="campings para familias, campings familiares, campings para niños, campings tranquilos, campings acogedores">
        
        <title>PlayCamp - Los mejores campings familiares de España</title>
