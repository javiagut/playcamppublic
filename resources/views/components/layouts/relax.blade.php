...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Campings dónde el relax es lo principal. Encuéntra tus vacaciones con sauna, hidromasaje, piscinas interiores, piscinas climatizadas, y hasta campings con servicio de masajes.">
        <meta keywords="campings tranquilos, campings de relax, campings chillout, campings con spa, campings con sauna, campings con piscina interior">
        
        <title>PlayCamp - Campings para disfrutar del relax</title>
